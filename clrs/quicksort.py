...
def lomuto_quicksort(data: list[int], start: int, end: int) -> None:
    ...
    i = lomuto_partition(data, start, end)
    lomuto_quicksort(data, start, i)
    lomuto_quicksort (data, i + 1, end)
...
def hoare_quicksort(data: list[int], start: int, end: int) -> None:
    ...
    p = hoare_partition(data, start, end)
    hoare_quicksort(data, start, p + 1)
    hoare_quicksort(data, p + 1, end)
